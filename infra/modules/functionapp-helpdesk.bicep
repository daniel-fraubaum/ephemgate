...
@description('Entra ID Client ID for Helpdesk app')
param entraClientId string

@description('Entra ID Tenant ID')
param entraTenantId string

var funcAppName = '${projectName}-hd-func'
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        { name: 'TAP_LIFETIME_MINUTES', value: '120' }
        { name: 'TAP_IS_USABLE_ONCE', value: 'true' }
        { name: 'TAP_DISPLAY_TIMEOUT_SECONDS', value: '120' }
        { name: 'BLOCKED_GROUP_IDS', value: '' }
        { name: 'NOTIFICATION_SENDER', value: '' }
